...
def mark_path_on_maze(maze, path):
    """
    Receives the original maze and a path (a list of coordinates [row, col]) and returns
    a new maze where the cells in the path are marked with an asterisk '*' for visual representation.
    """
...
# Only execute the following test code when running this file directly.
if __name__ == "__main__":
    # Example: Generate a maze of size 15x15, multipath enabled, with difficulty 0.5
